...
void Configuration::apply_nts_harmonic_penalty(const BaseSysData& baseData, const Parameters& pars, const std::valarray<int>& surNodes_mMesh, const std::valarray<int>& surNodes_mSegment, const std::valarray<int>& surNodes_mPart, const std::valarray<double>& surNodes_gap, bool Hessian, const long& timeStep)
{
    ...
    for (int nodeID = 0; nodeID <baseData.numSurfaceNodes; nodeID++){
                ...
                if (whichPart==2){
                    ...
                    double r0ix = xi-x0;
                    double r0iy = yi-y0;
                    double f0ix = -pars.ntsHarmonicPenaltyStiffness  * r0ix;
                    double f0iy = -pars.ntsHarmonicPenaltyStiffness  * r0iy;
                    double f00x = -f0ix;
                    double f00y = -f0iy;
...
//
                    ...
                    double r1iy = yi-y1;
                    double f = pars.ntsHarmonicPenaltyStiffness * abs(gap);
                    double f1ix = -pars.ntsHarmonicPenaltyStiffness  * r1ix;
                    double f1iy = -pars.ntsHarmonicPenaltyStiffness  * r1iy;
                    double f11x = -f1ix;
                    double f11y = -f1iy;
                    ...
                    if (Hessian){
                    add_d2_contributions_to_the_hessian(pars.ntsHarmonicPenaltyStiffness, xi,yi,x1,y1, node, node1, baseData);
                    }
